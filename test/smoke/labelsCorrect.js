...
describe('Labels are Correct', function () {
    ...
    it('TC-020 The second button label = "she"', function () {
        let labelShe = $$(sel.radioButtonsLabel)[1].getText();
        expect(labelShe).toEqual(exp.sheLabel);
    });

    it('TC-021 The third button label = "it"', function () {
        let labelIt = $$(sel.radioButtonsLabel)[2].getText();
        expect(labelIt).toEqual(exp.itLabel);
    });
